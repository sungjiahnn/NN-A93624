%% Surface vessel diameter extraction from 2P TIFF stack
...
%% -------------------- BLOCK 2: Draw vessel ROI + axis line --------------------
...
roiPoly = impoly(gca, [1 1; 1 20; 20 20; 20 1]); %#ok<IMPOLY>
...
%% -------------------- BLOCK 5: Remove motion artifacts --------------------
rawThresh = 0.5;
...
if exist('usfac','var')~=1, usfac=1; end %#ok<EXIST>
